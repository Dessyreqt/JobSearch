namespace JobSearch.Identity.Database.SqlServer.Models
{
    ...
    public class SqlServerConfiguration : SqlConfiguration
    {
        public SqlServerConfiguration()
        {
            ...
            SelectUserByIdQuery =
                "SELECT %SCHEMA%.%USERTABLE%.*, %SCHEMA%.%USERROLETABLE%.* FROM %SCHEMA%.%USERTABLE% LEFT JOIN %SCHEMA%.%USERROLETABLE% ON %SCHEMA%.%USERROLETABLE%.[UserId] =  %SCHEMA%.%USERTABLE%.[Id] WHERE [Id] = %ID%";
